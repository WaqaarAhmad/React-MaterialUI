...
const Feed = () => {
  ...
  return (
    <Container className={classes.container}>
      ...
      <Post title="Recipe That Will Make You Crave More" img="https://images.pexels.com/photos/7245477/pexels-photo-7245477.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500"/>
